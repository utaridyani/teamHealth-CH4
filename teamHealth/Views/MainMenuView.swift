...
struct MainMenuView: View {
    ...
    func triggerHapticByCircle(for circle: String, area: Int) {
        ...
        case "circle1":  // Twilight
            ...
            case 1: HapticManager.playAHAP(named: "twilight_80") // 80%
            case 2: HapticManager.playAHAP(named: "twilight_60") // 60%
            default: break
            }
        case "circle2":  // Reverie
            switch area {
            case 0: HapticManager.playAHAP(named: "reverie")     // 100%
            case 1: HapticManager.playAHAP(named: "reverie_80")  // 80%
            case 2: HapticManager.playAHAP(named: "reverie_60")  // 60%
            default: break
            }
        default:
            break
